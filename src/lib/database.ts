...
class SimulatedDatabase {
  ...
  private properties: Property[] = [
    {
      ...
      cleaningInstructions:
        "Atenção especial aos tapetes persas. Não usar produtos químicos fortes.",
  ...
  private cleaningTasks: CleaningTask[] = [
    {
      ...
      checklist: [
        ...
        {
          id: "check-004",
          description: "Verificar amenities",
          completed: false,
          required: true,
          category: "inspection",
        },
  ...
  getTaskById(id: string): CleaningTask | undefined {
    return this.cleaningTasks.find((t) => t.id === id);
  }
  createCleaningTask(
  ...
  createIntegration(
    integration: Omit<ApiIntegration, "id" | "createdAt" | "updatedAt">,
  ): ApiIntegration {
  ...
  getLowStockItems(): InventoryItem[] {
    return this.inventory.filter(
      (i) => i.currentStock <= i.minStock && i.active,
    );
  }
  ...
  getDashboardStats() {
    ...
    return {
      ...
      connectedIntegrations: this.integrations.filter(
