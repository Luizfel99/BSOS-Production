import WiredButton from "@/components/ui/WiredButton";import React, { useState, useEffect } from "react";
import {
  Calendar,
  MessageCircle,
  Star,
      ...
      <div
        ...
        <div className="bg-green-50 rounded-lg p-3">
            ...
            <div className="flex gap-3 mt-4">
              <WiredButton className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700" data-action="wire.auto">
                Download PDF
              </WiredButton>
              {invoice.status !== "paid" &&
          <WiredButton className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700" data-action="wire.auto">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-4">
              <WiredButton className="p-2 text-gray-600 hover:text-gray-900" data-action="wire.auto">
