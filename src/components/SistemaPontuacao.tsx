      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Avaliação automática com bonificação inteligente
          </p>
        </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">
                {filteredRatings.filter((r) => r.status === "pending").length}{" "}
                Pendentes
              </span>
              <span className="px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm">
                {filteredRatings.filter((r) => r.status === "disputed").length}{" "}
                Contestadas
              </span>
            </div>
          </div>
              ...
              <div key={rating.id} className="bg-white border rounded-lg p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-600">
                      {rating.propertyName} • {rating.date}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-bold text-purple-600">
                      {rating.supervisorRating.toFixed(1)}
                    </div>
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-600">
                      {performance.totalCleanings} limpezas realizadas
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <div className="text-center">
                    <div className="text-lg font-bold text-blue-600">
                      {performance.clientAverage.toFixed(1)}
                    </div>
                    <div className="text-xs text-gray-500">Clientes</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-purple-600">
                      {performance.supervisorAverage.toFixed(1)}
                    </div>
              ...
              <div key={rule.id} className="bg-white border rounded-lg p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="font-bold text-blue-600">
                      {rule.ratingThreshold.toFixed(1)}/5
                    </div>
                  </div>
                  <div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="mb-4">
              <p className="text-gray-600 mb-4">
                Isso processará todas as avaliações pendentes e calculará
                automaticamente as bonificações para o mês selecionado.
              </p>
