...
export default function BSOSManager() {
  ...
  // Estados para modais
  const [editValuesModal, setEditValuesModal] = useState({
    isOpen: false,
    taskId: "",
    currentValue: 0
  });
  ...
  const handleSaveSchedule = async (scheduleData: any) => {
    const result = await propertyHandlers.scheduleCleaning(
      scheduleModal.propertyId,
      scheduleData
    );
    if (result.success) {
  ...
  const handleViewFullReport = async (employeeId: string) => {
    utilHandlers.handleLocalAction("Abrindo relatório completo", () => {
      ...
      setSelectedEmployee(
        mockEmployees.find((emp) => emp.id === employeeId) || null
      );
    });
  };
  ...
  year: number) =>
  {
    const result = await employeeHandlers.updatePerformance(
      bonusModal.employeeId,
      {
        bonus,
        reason,
        month,
  ...
  const handleSaveValues = async (newValue: number, reason: string) => {
    ...
    success(
      `Valor atualizado para R$ ${newValue.toFixed(2)}. Motivo: ${reason}`
    );
  ...
  const handleApprovePayment = async (taskId: string) => {
    ...
    if (task) {
      ...
      if (result.success) {
        ...
        success(
          `Pagamento de R$ ${task.payment.total.toFixed(2)} aprovado! 💰`
        );
      }
    }
  };
  ...
  const handleGenerateAutoSchedule = async () => {
    utilHandlers.handleLocalAction("Gerando escala inteligente", async () => {
      ...
      loading("Analisando dados de performance e disponibilidade...", {
        duration: 2000
      });
        ...
        <div className="bg-white p-6 rounded-lg shadow border-l-4 border-green-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {mockEmployees.filter((e) => e.status !== "offline").length}/
            ...
            className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    property.status === "clean" ?
                    "bg-green-100 text-green-800" :
                    property.status === "needs-cleaning" ?
                    ...
                    <div className="flex items-center space-x-6 text-sm text-gray-600 mb-3">
                      ...
                      <span>
                        🗓️ Próxima:{" "}
                        {new Date(property.nextCleaning).toLocaleString(
                      "pt-BR"
                    )}
                      </span>
                    </div>
                    ...
                    const member = mockEmployees.find(
                      (e) => e.id === memberId
                    );
                    return member ?
                    <div
          ...
          <div key={employee.id} className="border rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      {employee.performance.onTimeRate}%
                    </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    style={{
                      width: `${employee.performance.qualityScore}%`
                    }}>
                  </div>
                    </div>
                  </div>
  ...
  <div className="space-y-6">
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">
            Internal Communication - Task Chat
          </h3>
        </div>
        <div className="p-6">
              ...
              <WiredButton
                ...
                "border-gray-200 hover:border-gray-300"}`
                    ...
                    <div className="text-xs text-gray-600">
                      {
                  mockEmployees.find((e) => e.id === task.assignedTo[0])?.
                  name
                  }
                    </div>
            ...
            <div className="border rounded-lg h-96 flex flex-col">
                  <div className="px-4 py-3 border-b bg-gray-50 rounded-t-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      {
                  mockEmployees.find(
                    (e) => e.id === selectedTask.assignedTo[0]
                  )?.name
                  }
                    </p>
                  </div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1">
                          <div className="bg-gray-100 rounded-lg p-3">
                            <p className="text-sm">
                              Iniciando limpeza do apartamento. Tudo ok com o
                              checklist!
                            </p>
                          </div>
                      ...
                      <div className="flex items-start space-x-2 justify-end">
                        <div className="flex-1">
                          <div className="bg-blue-500 text-white rounded-lg p-3 ml-12">
                            <p className="text-sm">
                              Perfeito! Lembre-se das fotos before/after.
                            </p>
                          </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Prioriza funcionários mais próximos para reduzir tempo de
                    deslocamento
                  </p>
                </div>
