...
const mockInvoices: Invoice[] = [
  {
    ...
    items: [
      {
        description: "Limpeza Normal - 2h30min",
        quantity: 1,
        unitPrice: 150,
        total: 150,
      },
  ...
  },
  {
    ...
    items: [
      {
        description: "Limpeza Profunda - 4h",
        quantity: 1,
        unitPrice: 300,
        total: 300,
      },
  ...
  const handleGeneratePaymentLink = async (invoiceId: string) => {
    try {
      const response = await fetch(
        `/api/finance/invoices/${invoiceId}/payment-link`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
        },
  ...
  const FinancialDashboard = () => (
    <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-red-700 text-sm">
                      INV-2025-002 - R$ 385 venceu há 2 dias
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-700 text-sm">
                      Meta mensal 85% atingida - faltam R$ 1.825
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">
            Top Properties by Profitability
          </h3>
        </div>
        <div className="p-6">
          <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {property.servicesCount} serviços este mês
                    </p>
                  </div>
                </div>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Criação e controle automático de faturas
          </p>
        </div>
        <button
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      {invoice.clientName} - {invoice.propertyName}
                    </p>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Gestão de pagamentos para clientes e equipe
          </p>
        </div>
        <button
  ...
  const PropertyProfitability = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Análise detalhada de custos, margem e lucro
        </p>
      </div>
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {property.servicesCount} serviços • Último:{" "}
                    {new Date(property.lastServiceDate).toLocaleDateString(
                      "pt-BR",
                    )}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div className="text-center p-4 bg-red-50 rounded-lg">
                  ...
                  <div className="text-xs text-red-600 mt-1">
                    {(
                      (property.totalCosts / property.monthlyRevenue) *
                      100
                    ).toFixed(1)}
                    % da receita
                  </div>
                ...
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  ...
                  <div className="text-xs text-purple-600 mt-1">
                    R${" "}
                    {(property.profitAmount / property.servicesCount).toFixed(
                      0,
                    )}
                    /serviço
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium">
                            R$ {property.laborCosts}
                          </div>
                          <div className="text-xs text-gray-500">
                            {(
                              (property.laborCosts / property.totalCosts) *
                              100
                            ).toFixed(0)}
                            %
                          </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium">
                            R$ {property.supplyCosts}
                          </div>
                          <div className="text-xs text-gray-500">
                            {(
                              (property.supplyCosts / property.totalCosts) *
                              100
                            ).toFixed(0)}
                            %
                          </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-green-600">
                          {(
                            (property.profitAmount / property.totalCosts) *
                            100
                          ).toFixed(0)}
                          %
                        </span>
  ...
  const BankingIntegration = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Conexões com Stripe, PayPal e QuickBooks
        </p>
      </div>
  ...
  const CommissionsReports = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Relatórios automáticos de pagamentos para equipe
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h4 className="font-medium text-gray-900">
              Janeiro 2025 - Relatório de Comissões
            </h4>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${
                          commission.role === "manager"
                            ? "bg-purple-100 text-purple-800"
                            : commission.role === "supervisor"
                              ? "bg-blue-100 text-blue-800"
                              : "bg-green-100 text-green-800"
                        }`}
                      >
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold mb-2">
              💰 BSOS Finance - Financial Management
            </h1>
            <p className="text-green-100">
              Gestão financeira completa e automatizada para sua empresa de
              limpeza
            </p>
