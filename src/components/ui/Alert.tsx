/**
 * BSOS Alert Component
 * 
 * A versatile alert component for displaying important messages with
 * different variants and optional dismiss functionality.
 */
      ...
      >
        <div className="flex items-start">
          ...
          <div className="flex-1 min-w-0">
            {title && (
              <h4 className={cn('text-sm font-medium mb-1', variantStyles.title)}>
                {title}
              </h4>
            )}
