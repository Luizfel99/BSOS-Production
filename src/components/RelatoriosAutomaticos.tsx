      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Relatórios PDF gerados automaticamente após cada auditoria
          </p>
        </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-600">
                      ...
                      <div>
                        ...
                        {relatorio.supervisor}
                      </div>
                      <div>
                        <span className="font-medium">Data:</span>{" "}
                        {new Date(relatorio.dataAuditoria).toLocaleDateString()}
                      </div>
                      <div>
                        <span className="font-medium">Duração:</span>{" "}
                        {relatorio.tempoAuditoria}
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      <span className="font-medium">Funcionário:</span>{" "}
                      {relatorioSelecionado.funcionario}
                    </div>
                    <div>
                      <span className="font-medium">Supervisor:</span>{" "}
                      {relatorioSelecionado.supervisor}
                    </div>
                    <div>
                      <span className="font-medium">Data:</span>{" "}
                      {new Date(
                    ...
                    <div>
                      ...
                      {relatorioSelecionado.tempoAuditoria}
                    </div>
                  </div>
                </div>
