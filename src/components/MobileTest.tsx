    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="flex items-center justify-between h-14 px-3">
          ...
          <div className="flex items-center space-x-2 min-w-0 flex-1">
            ...
            <h1
              className={`font-semibold text-gray-900 truncate ${isVerySmall ? "text-sm" : "text-base"}`}>
      ...
      <div className="p-3 space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
          <h3
            className={`font-semibold text-blue-900 mb-2 ${isVerySmall ? "text-sm" : "text-base"}`}>
          ...
          <div className="text-xs text-blue-700 space-y-1">
            ...
            <p>
              <strong>Very Small:</strong> {isVerySmall ? "Yes (≤360px)" : "No"}
            </p>
            <p>
              <strong>Status:</strong>{" "}
              {screenWidth < 360 ? "⚠️ Optimize needed" : "✅ Good"}
            </p>
          </div>
        </div>
          ...
          <div className="bg-white p-3 rounded-lg shadow border-l-4 border-blue-400">
            <div className="flex items-center">
              ...
              <div className="min-w-0">
                ...
                <p
                  className={`font-semibold text-gray-900 ${isVerySmall ? "text-lg" : "text-xl"}`}>
              ...
              <div className="flex justify-between items-start mb-2">
                <h5 className="font-medium text-gray-900 text-sm pr-2 flex-1 min-w-0">
                  <span className="truncate block">
                    Property {item} cleaning completed
                  </span>
                </h5>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3">
            <WiredButton className="w-full bg-blue-600 text-white py-4 px-4 rounded-lg font-medium touch-target hover:bg-blue-700 transition-colors" data-action="wire.auto">
              📷 Take Photo
            </WiredButton>
            <WiredButton className="w-full bg-green-600 text-white py-4 px-4 rounded-lg font-medium touch-target hover:bg-green-700 transition-colors" data-action="wire.auto">
              ✅ Complete Task
            </WiredButton>
            <WiredButton className="w-full bg-orange-600 text-white py-4 px-4 rounded-lg font-medium touch-target hover:bg-orange-700 transition-colors" data-action="wire.auto">
              📋 View Checklist
            </WiredButton>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-3">
          ...
          <div className="space-y-2">
            <p className="text-sm text-gray-600 break-words">
              This is a very long text that should wrap properly on small
              screens and not cause horizontal scrolling or overflow issues in
