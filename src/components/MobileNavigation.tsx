...
export const MobileNavigation: React.FC<MobileNavigationProps> = ({
  ...
  items || getNavigationForRole(authUser?.role || "CLEANER");
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="lg:hidden bg-white border-b border-gray-200 px-3 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-1 flex-shrink-0">
          <WiredButton className="p-2 text-gray-600 hover:text-gray-900 rounded-full" data-action="wire.auto">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="text-xs text-gray-500 capitalize">
                  {user?.role || "Cleaning Professional"}
                </p>
              </div>
            </div>
