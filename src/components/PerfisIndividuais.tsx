...
export default function PerfisIndividuais() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "performance" | "payments" | "training" | "communication">(
    "overview");
  const [viewMode, setViewMode] = useState<"grid" | "list">("grid");
  const [filterRole, setFilterRole] = useState<string>("all");
  const [sortBy, setSortBy] = useState<"rating" | "cleanings" | "earnings">(
    "rating"
  );
    ...
    className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow cursor-pointer p-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1 mt-1">
            ...
            <span className="text-gray-500 text-sm">
              ({employee.totalCleanings} limpezas)
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-3">
        <div className="flex justify-between text-sm mb-1">
          ...
          <span>
            {employee.currentProgress}/{employee.monthlyGoal}
          </span>
        </div>
        <div className="w-full bg-gray-200 rounded-full h-2">
          ...
          style={{
            width: `${Math.min(employee.currentProgress / employee.monthlyGoal * 100, 100)}%`
          }}>
        </div>
        </div>
      </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="opacity-75">
                      • {selectedEmployee.totalCleanings} limpezas
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {selectedEmployee.totalCleanings}
                      </div>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <div className="text-2xl font-bold text-purple-600">
                        R$ {selectedEmployee.totalEarnings}
                      </div>
                  ...
                  <div>
                    ...
                    <div
                      ...
                      <p className="text-sm text-gray-700 italic">
                              &ldquo;{cleaning.clientFeedback}&rdquo;
                            </p>
                      }
                        </div>
                    )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        <strong>Entrada:</strong> {selectedEmployee.joinDate}
                      </div>
                      <div>
                        <strong>Zonas:</strong>{" "}
                        {selectedEmployee.zones.join(", ")}
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-4 rounded-lg text-white">
                    <div className="text-2xl font-bold">
                      {selectedEmployee.monthlyRating.toFixed(1)}
                    </div>
                    <div className="text-blue-100">Nota Mensal</div>
                    <div
                    className={`mt-2 px-2 py-1 rounded text-xs ${calculateBonusColor(selectedEmployee.monthlyRating)}`}>
                  ...
                  <div className="bg-gradient-to-r from-green-500 to-green-600 p-4 rounded-lg text-white">
                    <div className="text-2xl font-bold">
                      {selectedEmployee.clientRatings.toFixed(1)}
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-lg text-white">
                    <div className="text-2xl font-bold">
                      {selectedEmployee.supervisorRatings.toFixed(1)}
                    </div>
                    <div className="text-purple-100">
                      Avaliação Supervisores
                    </div>
                  </div>

                  <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4 rounded-lg text-white">
                    <div className="text-2xl font-bold">
                      {selectedEmployee.currentProgress}%
                    </div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Gestão completa da equipe com avaliações e performance
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            onSubmit={(e) => {
              ...
              <div className="flex gap-3 mt-6">
                ...
                <WiredButton
                type="submit"
                className="flex-1 bg-blue-600 text-white px-6 py-4 sm:px-4 sm:py-2 rounded-lg hover:bg-blue-700 touch-target" data-action="wire.auto">
