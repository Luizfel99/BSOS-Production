    ...
    <div className="min-h-screen bg-primary py-8">
      <div className="container mx-auto px-4 space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <Caption>
            Phase 9 - Global Visual Design System Implementation
          </Caption>
        </div>
          ...
          <CardBody>
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <Typography variant="display1">
                    Display 1 - Main Headlines
                  </Typography>
                  <Typography variant="display2">
                    Display 2 - Secondary Headlines
                  </Typography>
                  <Typography variant="display3">
                    Display 3 - Tertiary Headlines
                  </Typography>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <Text size="base">
                    Body 1 - Regular paragraph text for general content
                  </Text>
                  <Text size="sm">
                    Body 2 - Smaller text for secondary information
                  </Text>
          ...
          <CardBody>
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Input size="sm" label="Small Size" placeholder="Small input" />
                <Input
                  size="md"
                  label="Medium Size"
                  placeholder="Medium input"
                />
                <Input size="lg" label="Large Size" placeholder="Large input" />
              </div>
        ...
        >
          <ModalBody>
            <div className="space-y-4">
              <Text>
                This is a test modal demonstrating the BSOS design system modal
                component.
              </Text>
        ...
        <Card variant="ghost" padding="lg">
          <div className="text-center space-y-2">
            ...
            <Caption>
              All components follow accessibility standards and responsive
              design principles
            </Caption>
          </div>
        </Card>
