...
const ROLE_PERMISSIONS = {
  owner: ["general", "permissions", "integrations"],
...
export default function SettingsPage() {
  ...
  const canAccessTab = (tab: string): boolean => {
    ...
    // For now, allow access to all tabs - RBAC can be refined later
    return true;
  };
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    {(!settings.business || settings.business.length === 0) && (
                      <p className="text-gray-500">
                        No business settings configured yet.
                      </p>
                    )}
                  </div>
                </div>
                        ...
                        {Object.entries(PERMISSION_DESCRIPTIONS).map(
                          ([permission, description]) => (
                            <tr key={permission}>
                              ...
                              <td className="px-6 py-4 text-center">
                                {["manage_users", "manage_settings"].includes(
                                  permission,
                                ) ? (
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    {(!settings.permissions ||
                      ...
                      <p className="text-gray-500">
                        No permission settings configured yet.
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <IntegrationCard
                      ...
                      onConnect={() =>
                        toast("Stripe integration configuration coming soon", {
                          icon: "🚧",
                        })
                      }
                    />
                    ...
                    <IntegrationCard
                      ...
                      onConnect={() =>
                        toast("Airbnb integration in development", {
                          icon: "🚧",
                        })
                      }
                    />
                    ...
                    <IntegrationCard
                      ...
                      onConnect={() =>
                        toast("Hostaway integration in development", {
                          icon: "🚧",
                        })
                      }
                    />
                    ...
                    <IntegrationCard
                      ...
                      onConnect={() =>
                        toast("Google integration in development", {
                          icon: "🚧",
                        })
                      }
                    />
