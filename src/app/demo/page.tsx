              ...
              {activeDemo === "responsive" ? (
                <div>
                  ...
                  <ul className="text-blue-100 text-sm mt-2 space-y-1">
                    <li>
                      📱 <strong>Mobile (&lt; 768px):</strong> Slide-out
                      navigation drawer
                    </li>
                    <li>
                      📟 <strong>Tablet (768px - 1023px):</strong> Horizontal
                      navigation bar
                    </li>
                    <li>
                      🖥️ <strong>Desktop (≥ 1024px):</strong> Fixed sidebar
                      navigation
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-blue-100 text-sm mt-2 space-y-1">
                    <li>
                      ✅ <strong>Success:</strong> Operações bem-sucedidas
                      (verde)
                    </li>
                    <li>
                      ❌ <strong>Error:</strong> Erros e falhas (vermelho)
                    </li>
                    <li>
                      ⚠️ <strong>Warning:</strong> Avisos importantes (amarelo)
                    </li>
                    <li>
                      💡 <strong>Info:</strong> Informações gerais (azul)
                    </li>
                  </ul>
                </div>
              )}
