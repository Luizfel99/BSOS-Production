...
const TEST_SCENARIOS = [
  ...
  },
  {
    ...
    tests: [
      { name: 'Create Task Button', selector: 'button:has-text("Criar Tarefa")', expected: 'modal_or_navigation' },
      { name: 'Manage Team Button', selector: 'button:has-text("Gerenciar Equipe")', expected: 'modal_or_navigation' },
      { name: 'View Reports Button', selector: 'button:has-text("Ver Relatórios")', expected: 'modal_or_navigation' },
      { name: 'System Settings Button', selector: 'button:has-text("Configurações")', expected: 'modal_or_navigation' }
    ]
  },
  {
    module: 'Tasks Module',
    tests: [
      { name: 'New Task Button', selector: 'button:has-text("Nova Tarefa")', expected: 'modal_or_navigation' },
      { name: 'Filter Button', selector: 'button[title*="filter"], button:has-text("Filtro")', expected: 'modal_or_dropdown' },
      { name: 'Export Button', selector: 'button:has-text("Exportar")', expected: 'action_or_download' }
    ]
  },
  {
