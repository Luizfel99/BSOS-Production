...
const TEST_SCENARIOS = [
  ...
  },
  {
    ...
    tests: [
      { name: 'Primary Property Button', selector: 'button[class*="bg-green"]', expected: 'modal_or_navigation' },
      { name: 'Secondary Property Button', selector: 'button[class*="bg-blue"]', expected: 'modal_or_navigation' },
      { name: 'Property Card Button', selector: '.property-card button, .bg-white button', expected: 'modal_or_action' }
    ]
  },
  {
    module: 'Finance Module',
    tests: [
      { name: 'Primary Finance Button', selector: '.finance-actions button:first-child', expected: 'modal_or_action' },
      { name: 'Secondary Finance Button', selector: '.finance-actions button:nth-child(2)', expected: 'action_or_toast' },
      { name: 'Finance Action Button', selector: 'button[class*="bg-purple"], button[class*="bg-green"]', expected: 'action_or_download' }
    ]
  },
  {
    module: 'Settings Module',
    tests: [
      { name: 'Settings Tab Button', selector: 'nav button', expected: 'tab_change' },
      { name: 'Settings Action Button', selector: '.settings-page button[class*="bg-blue"]', expected: 'modal_or_action' },
      { name: 'Save Button', selector: 'button[type="submit"]', expected: 'action_or_toast' }
    ]
  }
];
