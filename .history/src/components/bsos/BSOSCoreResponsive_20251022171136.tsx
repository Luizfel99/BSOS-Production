...
export default function BSOSCoreResponsive() {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: Home, href: '#dashboard', roles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'CLEANER'], priority: 1 },
    { id: 'schedule', label: 'Schedule', icon: Calendar, href: '#schedule', roles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'CLEANER'], priority: 2 },
    { id: 'tasks', label: 'Tasks', icon: CheckCircle, href: '#tasks', roles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'CLEANER'], priority: 3 },
    { id: 'photos', label: 'Photos', icon: Camera, href: '#photos', roles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'CLEANER'], priority: 4 },
    { id: 'reports', label: 'Reports', icon: FileText, href: '#reports', roles: ['OWNER', 'MANAGER', 'SUPERVISOR'], priority: 5 },
    { id: 'analytics', label: 'Analytics', icon: BarChart3, href: '#analytics', roles: ['OWNER', 'MANAGER'], priority: 6 },
    { id: 'settings', label: 'Settings', icon: Settings, href: '#settings', roles: ['OWNER', 'MANAGER'], priority: 7 },
  ];
