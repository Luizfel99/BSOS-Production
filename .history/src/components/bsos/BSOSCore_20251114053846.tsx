...
export default function BSOSCore() {
  ...
  const dashboardConfig = {
    canCreateTasks: user && ['supervisor', 'manager', 'owner', 'admin'].includes(user.role),
    canApproveTasks: user && ['supervisor', 'manager', 'owner', 'admin'].includes(user.role),
    canViewReports: user && ['supervisor', 'manager', 'owner', 'admin'].includes(user.role),
